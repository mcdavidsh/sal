...
<footer class="sal-secondary-dark-bg dark:bg-gray-900 px-0 md:px-10 lg:px-10">
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 py-8 px-6 flex flex-col justify-center text-center md:flex-none md:flex-row  md:text-left lg:flex-none lg:flex-row lg:justify-start ">
        ...
        <div>
            ...
            <div class="flex mt-4 space-x-2 justify-center sm:justify-center md:justify-start md:mt-2 mx-auto">
                <a href="<?php the_field( "facebook_link", "options" ) ?>"
                   class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M26.5 32.3332H21.5C17.3334 32.3332 15.6667 30.6665 15.6667 26.4998V21.4998C15.6667 17.3332 17.3334 15.6665 21.5 15.6665H26.5C30.6667 15.6665 32.3334 17.3332 32.3334 21.4998V26.4998C32.3334 30.6665 30.6667 32.3332 26.5 32.3332Z"
                              stroke="white" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>

                    <span class="sr-only">Facebook page</span>
                </a>
                <a href="<?php the_field( "youtube_link", "options" ) ?>"
                   class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="48" height="48" rx="24" fill="#343538"/>
                        <path d="M28.1666 30.6668H19.8333C17.3333 30.6668 15.6666 29.0002 15.6666 26.5002V21.5002C15.6666 19.0002 17.3333 17.3335 19.8333 17.3335H28.1666C30.6666 17.3335 32.3333 19.0002 32.3333 21.5002V26.5002C32.3333 29.0002 30.6666 30.6668 28.1666 30.6668Z"
                              stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M23.5 21.9168L25.5833 23.1668C26.3333 23.6668 26.3333 24.4168 25.5833 24.9168L23.5 26.1668C22.6667 26.6668 22 26.2501 22 25.3334V22.8334C22 21.7501 22.6667 21.4168 23.5 21.9168Z"
                              stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>

                    <span class="sr-only">Youtube</span>
                </a>
                <a href="<?php the_field( "dribble_link", "options" ) ?>"
                   class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="48" height="48" rx="24" fill="#343538"/>
                        <path d="M29.4167 17.9917C27.25 21.7834 23.075 23.9584 18.725 23.5667L16.0834 23.325"
                              stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M18.5834 30.1417C20.75 26.3501 24.925 24.1751 29.275 24.5667L31.9167 24.8084"
                              stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M24 32.3332C28.6023 32.3332 32.3333 28.6022 32.3333 23.9998C32.3333 19.3975 28.6023 15.6665 24 15.6665C19.3976 15.6665 15.6666 19.3975 15.6666 23.9998C15.6666 28.6022 19.3976 32.3332 24 32.3332Z"
                              stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M20.3583 16.5L23.0083 19.7917C24.7833 21.9917 26.0416 24.55 26.7083 27.2917L27.7166 31.45"
                              stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>

                    <span class="sr-only">Dribble</span>
                </a>
                <a href="<?php the_field( "whatsapp_link", "options" ) ?>"
                   class="text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="48" height="48" rx="24" fill="#343538"/>
